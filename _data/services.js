...
module.exports = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes  --  from a single faucet repair to full rough-in for a remodel or addition. We handle residential and light commercial plumbing across the full scope.'
      },
      {
        q: 'My home was built in the 1970s. Should I be worried about my pipes?',
        a: 'Homes built before 1980 in {{CITY_NAME}} and {{COUNTY_NAME}} often have galvanized steel supply lines or cast iron drain lines approaching end of life. We can inspect your system and give you an honest assessment  --  no pressure to replace anything that doesn\'t need it.'
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: 'Units under 8 years old with a single failure point  --  an element, thermostat, or anode rod  --  are usually worth repairing. Units over 12 years old, or those with tank corrosion or recurring failures, typically make more sense to replace. We\'ll give you an honest assessment on arrival.'
      },
      {
      ...
      },
      {
        ...
        a: 'Most standard tank replacements take 2 -- 3 hours. Tankless installations take longer depending on venting and gas line requirements  --  typically 3 -- 5 hours. We\'ll give you a time estimate before we start.'
      },
      {
        q: 'Why does my water heater make a popping or rumbling noise?',
        a: 'That sound is mineral scale  --  common in {{COUNTY_NAME}} due to hard water  --  accumulating on the heating element or tank floor. It means the heater is working harder than normal. A flush or element replacement often resolves it and extends the unit\'s life.'
      },
      {
  ...
  },
  {
    ...
    urgencyNote: 'A completely stopped drain  --  especially on the main line  --  needs same-day attention. We\'re available 24/7 for drain emergencies in {{CITY_NAME}}.',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Recurring clogs in the same location usually indicate a structural problem  --  root intrusion, a belly in the pipe, or a cracked joint collecting debris. We camera inspect to find the cause so we\'re fixing the actual problem, not just clearing it again.'
      },
      {
        q: 'How do I know if my main sewer line is clogged vs. a single drain?',
        a: 'If multiple fixtures are draining slowly  --  or if flushing the toilet causes water to back up in the tub or shower  --  that points to a main line issue rather than a single branch drain. Call us immediately; a main line backup needs same-day service.'
      },
      {
      ...
      },
      {
        ...
        a: 'Yes  --  and it\'s very common in {{COUNTY_NAME}} neighborhoods with mature trees. Roots enter through clay tile joints and slowly fill the pipe over years. Regular rooter service can keep it clear, but if the intrusion is severe enough, line repair or replacement is the long-term solution.'
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Common signs include warm spots on the floor (hot water line), the sound of running water when no fixtures are in use, unexplained increases in your water bill, or cracks appearing in floors or walls. Slab leaks get worse over time  --  call us for a diagnosis.'
      },
      {
        q: 'Can a small leak really cause serious damage?',
        a: 'Yes. A pinhole leak inside a wall can saturate insulation and framing for months before it becomes visible. Mold can begin forming within 24 -- 48 hours of moisture exposure in enclosed spaces. Early detection is significantly cheaper than remediation after structural damage.'
      },
      {
        q: 'My water bill jumped this month  --  could it be a leak?',
        a: 'A sudden spike with no change in usage patterns is a common indicator of a hidden leak. Check your meter with all fixtures off  --  if the dial is still moving, water is running somewhere. Call us and we\'ll locate it.'
      },
      {
        q: 'Do you repair the leak after you find it, or just locate it?',
        a: 'We do both. Once we locate the leak, we\'ll quote the repair before opening anything. Our goal is to find it, fix it, and leave the site in good shape  --  not hand you a locating report and leave the repair to someone else.'
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: 'A continuously running toilet typically wastes 200 gallons per day  --  that\'s roughly $15 -- $20 per week added to your water bill depending on your utility rate. Most running toilet repairs cost less than two months of that waste.'
      },
      {
        q: 'Can you fix a dripping faucet same-day in {{CITY_NAME}}?',
        a: 'Usually yes. Most dripping faucets are a cartridge or washer replacement, and we carry common parts. Call (316) 333-6326 and describe your faucet brand  --  we\'ll confirm parts availability before coming out.'
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. Old angle stop valves that haven\'t been operated in years frequently fail when turned  --  either they won\'t close, or they leak when reopened. We inspect and can replace them at the same visit before they become an emergency.'
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: 'Yes  --  install-only is available. Bring your own fixture and we\'ll connect it properly, check for leaks, and make sure the supply valves and drain connections are in good shape. We\'ll flag anything that looks like a problem before we start.'
      },
      {
        q: 'Do you supply fixtures or just install them?',
        a: 'Both. We can supply standard fixtures or install customer-supplied units. For specialty or designer fixtures, it\'s often easier to source your own  --  we\'ll install whatever you\'ve chosen.'
      },
      {
        q: 'How long does a toilet replacement take?',
        a: 'Most toilet replacements are 1 -- 2 hours including the shutoff valve check and supply line replacement. If the flange needs repair or the floor has damage from a previous leak, that adds time  --  we\'ll identify that before starting.'
      },
      {
        q: 'What\'s involved in replacing a bathroom sink and faucet?',
        a: 'A basic drop-in sink and faucet swap takes 1 -- 2 hours. Undermount sinks and vessel sinks require more coordination with the countertop. We check the drain, P-trap, and shutoff valves at the same time  --  these are common failure points on older systems.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'We perform a pressure test on the gas line system  --  this identifies leaks without requiring visible damage or a gas smell. If a leak is confirmed, we locate the source and repair it before restoring service.'
      },
      {
  ...
  },
  {
    ...
    urgencyNote: 'Remodel timelines depend on plumbing. Book early  --  kitchen and bathroom rough-in slots in {{CITY_NAME}} fill up faster than most homeowners expect.',
    cta: 'Call to schedule kitchen or bathroom plumbing',
    faqs: [
      {
        q: 'Do I need a plumber for a kitchen remodel in {{CITY_NAME}}?',
        a: 'If you\'re moving or adding any plumbing  --  sink relocation, island supply line, dishwasher rough-in  --  yes, a licensed plumber is required. Even swapping a sink in place benefits from a professional connection to avoid drain leaks and supply line failures.'
      },
      {
        q: 'When does the plumber come in during a bathroom remodel?',
        a: 'Twice. Rough-in happens before tile and drywall  --  supply and drain lines are set in the wall and floor. Trim-out happens after tile and drywall finish  --  fixtures are installed and connected. We coordinate both visits around your remodel schedule.'
      },
      {
      ...
      {
        q: 'My garbage disposal is leaking under the sink  --  can you fix it same-day?',
        a: 'Usually yes. Garbage disposal leaks are typically a failed sink flange seal, a cracked housing, or a loose drain connection  --  most of which we can repair or replace same-day. Call (316) 333-6326 to schedule.'
      },
      {
