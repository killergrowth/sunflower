      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:#ffffff;padding:36px 40px;">
          <p style="margin:0 0 24px;color:#121315;font-size:15px;line-height:1.6;">
            A new service request was submitted through the Sunflower Plumbing website. Here are the details:
          </p>

          <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            <tr>
              <td style="padding:12px 16px;background:#f9f5f0;border-left:3px solid #FCAF18;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1px;width:120px;">Name</td>
              <td style="padding:12px 16px;background:#f9f5f0;font-size:15px;color:#121315;font-weight:bold;">${name}</td>
            </tr>
            <tr>
              <td style="padding:12px 16px;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1px;">Email</td>
              <td style="padding:12px 16px;font-size:15px;color:#121315;">${email ? `<a href="mailto:${email}" style="color:#FCAF18;">${email}</a>` : 'Not provided'}</td>
            </tr>
            <tr>
              ...
              <td style="padding:12px 16px;background:#f9f5f0;font-size:15px;color:#121315;">${phone || 'Not provided'}</td>
            </tr>
            <tr>
              <td style="padding:12px 16px;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:1px;">Address</td>
              <td style="padding:12px 16px;font-size:15px;color:#121315;">${address || 'Not provided'}</td>
            </tr>
            <tr>
              ...
              <td style="padding:12px 16px;background:#f9f5f0;font-size:15px;color:#121315;">${serviceLabel}</td>
            </tr>
          </table>
          ...
          <div style="margin-top:24px;">
            ...
            <div style="background:#f9f5f0;border-left:3px solid #FCAF18;padding:16px;font-size:15px;color:#121315;line-height:1.7;">${message.replace(/\n/g, '<br>')}</div>
          </div>` : ''}

          ${phone ? `<div style="margin-top:32px;text-align:center;"><a href="tel:${phone.replace(/\D/g, '')}" style="display:inline-block;background:#FCAF18;color:#121315;font-size:16px;font-weight:700;padding:14px 36px;border-radius:4px;text-decoration:none;letter-spacing:1px;text-transform:uppercase;">Call ${phone}</a></div>` : ''}
        </td></tr>
...
const JSON_HEADERS = {
  ...
  'Access-Control-Allow-Origin': 'https://sunflowerplumbing.com',
};
...
export async function onRequestPost({ request, env }) {
  try {
    ...
    const subject  = 'New Service Request - Sunflower Plumbing';
